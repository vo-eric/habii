...
// Function to create service account credentials from environment variables
  ...
  async connect(): Promise<void> {
    ...
    try {
      ...
      if (admin.apps.length > 0) {
        ...
        // Use provided config, environment variables, or fall back to emulator
        ...
        if (!appConfig) {
          ...
          console.log(
            'Using service account from environment variables for authentication'
          );
        }
